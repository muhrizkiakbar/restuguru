    ...
    <div class="wrapper">
        ...
        <section class="invoice">
            ...
            <div class="col-xs-12">
                ...
                <img src="{{secure_asset('dist/img/rg.png')}}" class="logorg"> <strong>RESTU GURU PROMOSINDO</strong> Cab. {{$transaksi->Nama_Cabang}}
                <small class="pull-right" style="margin-top:5px !important;"> Angsuran Pengeluaran Detail <br>{{$transaksi->jenis_pengeluaran}}</small>
                <br/>
            ...
            @if ($transaksi->sisa_pengeluaran==0)
                <img src="{{secure_asset('dist/img/brush_lunas.png')}}" class="status">
            @endif
