            ...
            <div class="box box-success">
              ...
              <!-- form start -->
                ...
                <div class="box-footer">
                  ...
                  <button type="submit" id="submitpelanggan" name="submitpelanggan" value="export" class="btn btn-success btn-sm">Export <i class="fa fa-chevron-circle-right"></i></button>
                </div>
            </div>
          </div>
          </form>
