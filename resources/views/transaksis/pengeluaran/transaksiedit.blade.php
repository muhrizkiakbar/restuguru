...
@section('body')
    ...
    <script>
      ...
      var subtotaldelete=0;
        ...
        var total4={{$transaksi->total_pengeluaran}};
        var bayardp4={{$transaksi->pembayaran_pengeluaran}};
        var sisa4={{$transaksi->sisa_pengeluaran}};
