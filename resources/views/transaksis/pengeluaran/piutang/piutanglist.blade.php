                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tr id="{{$data->id}}">
                                ...
                                <td style="width: 150px;min-width:140px;">
                                    <div class="btn-group">
                                        <button type="button" id="showtombol{{$data->id}}" class="detail_show btn btn-primary btn-xs"  data-id="{{encrypt($data->id)}}" data-idsisa="sisa{{$data->id}}" data-nonota="{{$data->id}}" data-sisa="{{ $data->sisa_pengeluaran}}" data-pembayaran="{{$data->pembayaran_pengeluaran}}"><i class="fa fa-eye"></i></button>
